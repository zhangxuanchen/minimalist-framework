...
class TypeParameterResolver {
   ...
   static class WildcardTypeImpl implements WildcardType {
    ...
    public static Class<?> getGenericInterfacesBean(Class<?> proxyClass) {
        Class<?> entityClass = null;
        Type[] genericInterfaces = proxyClass.getGenericInterfaces();
        for(Type superclass : genericInterfaces){
            if(superclass instanceof ParameterizedType){
